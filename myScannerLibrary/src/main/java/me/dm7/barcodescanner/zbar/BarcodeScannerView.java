...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback  {
    ...
    public void startCamera(Camera camera,boolean flash) {
        mCamera = camera;
        if(mCamera != null) {
            mViewFinderView.setupViewFinder();
            mPreview.setCamera(mCamera, this);
            mPreview.initCameraPreview(flash);
        }
    }

    public void startCamera(boolean flash) {
        startCamera(CameraUtils.getCameraInstance(),flash);
    }
